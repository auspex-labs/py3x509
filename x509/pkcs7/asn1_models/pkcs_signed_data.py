...
class SignedContent(univ.SequenceOf):
    ...
    tagSet = univ.SequenceOf.tagSet.tagImplicitly(tag.Tag(tag.tagClassUniversal, tag.tagFormatConstructed, 0x04))
...
class Content(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType(
            "signed_content", SignedContent().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0x0))
        ),
    )
...
class MsgType(univ.ObjectIdentifier):
    pass


class SignVersion(univ.Integer):
    pass


class IssuerAndSerial(univ.Sequence):
    componentType = namedtype.NamedTypes(namedtype.NamedType("issuer", Name()), namedtype.NamedType("serialNumber", univ.Integer()))
...
class AuthAttribute(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType("type", univ.ObjectIdentifier()), namedtype.NamedType("value", AuthAttributeValue())
    )
...
class SignerInfo(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType(
            "authAttributes", Attributes().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0x0))
        ),
        namedtype.NamedType("encryptAlg", AlgorithmIdentifier()),
        namedtype.NamedType("signature", univ.OctetString()),
        namedtype.OptionalNamedType(
            "unauthAttributes", Attributes().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0x1))
        ),
    )
...
class V1Content(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType("content", Content()),
        namedtype.OptionalNamedType(
            "certificates", Certificates().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0x0))
        ),
        namedtype.OptionalNamedType(
            "crls", Crls().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0x1))
        ),
...
class Message(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType(
            "content", V1Content().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0x0))
        ),
    )
...
class EncapsulatedContent(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType(
            "eContent", univ.OctetString().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0x0))
        ),
    )
...
class QtsContent(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType(
            "certificates", CertificateSet().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0x0))
        ),
        namedtype.OptionalNamedType(
            "crls", Crls().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0x1))
        ),
...
class Qts(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType("type", MsgType()),
        namedtype.NamedType(
            "content", QtsContent().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0x0))
        ),
    )
